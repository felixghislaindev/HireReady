  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Sign up for HireReady to kickstart your job search and interview preparation."
        />
      ...
      <main className="bg-black text-white min-h-screen flex flex-col justify-center items-center">
        <section className="bg-black text-white text-center py-12 px-8 w-full md:w-1/3 rounded-lg shadow-lg">
          ...
          <p className="text-gray-400 mb-8">
            Sign up to access all the features of HireReady and transform your
            interview prep.
          </p>
